# flake8: noqa
# only E501's and this file is generated
#
# generated by datamodel-codegen:
#   filename:  openapi.yaml
#   timestamp: 2023-06-19T10:15:09+00:00
...
class ChangeFileOperation(BaseModel):
    content: Optional[str] = Field(
        None, description="new or updated file content, must be base64 encoded"
    )
    from_path: Optional[str] = Field(None, description="old path of the file to move")
    operation: Operation = Field(..., description="indicates what to do with the file")
...
class CreateBranchRepoOption(BaseModel):
    ...
    old_branch_name: Optional[str] = Field(
        None, description="Deprecated: true\nName of the old branch to create from"
    )
    old_ref_name: Optional[str] = Field(
        None, description="Name of the old branch/tag/commit to create from"
    )
...
class CreateLabelOption(BaseModel):
    ...
    exclusive: Optional[bool] = Field(None, example=False)
    name: str
...
class CreatePullReviewOptions(BaseModel):
    ...
    event: Optional[str] = Field(None, description="ReviewStateType review state type")
...
class MarkdownOption(BaseModel):
    ...
    Mode: Optional[str] = Field(
        None, description="Mode to render (comment, gfm, markdown)\n\nin: body"
    )
...
class MarkupOption(BaseModel):
    ...
    FilePath: Optional[str] = Field(
        None, description="File path for detecting extension in file mode\n\nin: body"
    )
    Mode: Optional[str] = Field(
        None, description="Mode to render (comment, gfm, markdown, file)\n\nin: body"
    )
    Text: Optional[str] = Field(None, description="Text markup to render\n\nin: body")
    Wiki: Optional[bool] = Field(None, description="Is it a wiki page ?\n\nin: body")
...
class Milestone(BaseModel):
    ...
    state: Optional[str] = Field(None, description="StateType issue state type")
    title: Optional[str] = None
    updated_at: Optional[datetime] = None
...
class UserHeatmapData(BaseModel):
    ...
    timestamp: Optional[int] = Field(None, description="TimeStamp defines a timestamp")
...
class IssueCreateIssueCommentAttachmentRequest(BaseModel):
...
class EditRepoOption(BaseModel):
    ...
    has_actions: Optional[bool] = Field(
        None,
    ...
    has_packages: Optional[bool] = Field(
        None,
    ...
    has_releases: Optional[bool] = Field(
        None,
...
class PullReview(BaseModel):
    ...
    state: Optional[str] = Field(None, description="ReviewStateType review state type")
